...
## System folder audit helper

Use `system_audit.sh` to generate a quick audit report for a target directory:

```bash
bash system_audit.sh "/path/to/target" "audit_report.md"
```
